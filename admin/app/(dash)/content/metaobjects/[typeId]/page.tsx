  ...
  return (
    <section className="max-w-3xl space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/content/metaobjects" className="text-sm text-[color:var(--color-text-muted)] hover:underline">← Metaobjects</Link>
              ...
              <li key={e.id}>
                <Link href={`/content/metaobjects/${typeId}/entries/${e.id}`}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-[color:var(--color-text-muted)] font-mono">{e.handle}</div>
                  </div>
