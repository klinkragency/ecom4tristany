    ...
    <div className="fixed inset-0 bg-black/40 grid place-items-center z-50 p-4">
      <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl flex flex-col max-h-[80vh]">
        <div className="p-4 border-b border-[color:var(--color-border)] flex items-center justify-between">
          ...
          <button onClick={onClose} className="text-sm text-[color:var(--color-text-muted)] hover:text-black">
            ✕
          </button>
        </div>
        ...
        <div className="overflow-y-auto flex-1">
          {error && (
            <div className="m-3 rounded border border-red-200 bg-red-50 text-red-700 text-sm px-3 py-2">
              {error}
            </div>
          )}
          {page && page.items.length === 0 && (
            <div className="p-4 text-sm text-[color:var(--color-text-muted)]">No products found.</div>
          )}
        ...
        <div className="p-4 border-t border-[color:var(--color-border)] flex items-center justify-between">
